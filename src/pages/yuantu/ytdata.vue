        ...
        <el-row class="data-el-row">
            <el-col :span="12" >
                <el-row>
                    <el-col>
                    <div>>>>获取医管账号:</div>
                    <el-select size="small" v-model="value" placeholder="请选择" @change="getOptionsValue(value)">
                        <el-option
                    ...
                    <el-button size="small" @click="getAccount">获取</el-button>
                    </el-col>
                </el-row>
              <el-row>
                  <el-row>
                  ...
                  <el-col :span="8">
                  <el-input size="medium" clearable maxlength="11" placeholder="请输入排班医生手机号（默认青岛）" v-model="inputValue"></el-input>
                  </el-col>

                  <el-col :span="8">
                      <el-button size="small">排班</el-button>
                  </el-col>
                  </el-row>
              </el-row>

            </el-col>
            <el-col :span="12" class="dataTable" v-show="true">
